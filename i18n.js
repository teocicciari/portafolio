(function () {
    const translations = {
        es: {
            ...
            // Hero
            'hero.title': 'Presencia Digital Gestionada',
            'hero.subtitle': 'Diseño tu web a medida y me ocupo de que trabaje todo el año: hosting, contenido al día y reporte mensual de resultados.',
            'hero.feature_1': '100% Personalizadas',
            'hero.feature_2': 'Distintos tamaños de pantalla',
            'hero.feature_3': 'Optimizadas',
            'hero.badge': '✦ Web a medida + gestión mensual opcional',
            ...
            'projects.available_design': 'Diseño disponible',
            'projects.category.chess': 'Ajedrez',
            ...
            'premium.subtitle': 'Sitios web con animaciones avanzadas, interactividad cautivante y diseño award-worthy. Experiencias digitales que dejan marca.',
            'premium.example_title': 'Ejemplo: VISUALUV',
            'premium.example_desc': 'Portfolio de fotografía con diseño minimalista, animaciones de scroll fluidas y navegación intuitiva.',
            'premium.includes': 'Incluye:',
            'premium.feature_animations': 'Animaciones avanzadas con GSAP y/o Three.js',
            'premium.feature_interactions': 'Interactividad personalizada y microinteracciones',
            'premium.feature_performance': 'Optimización de rendimiento y Web Vitals',
            'premium.feature_mobile': 'Diseño responsive y mobile-first',
            'premium.feature_seo': 'SEO avanzado y metadata',
            'premium.feature_support': 'Soporte técnico extendido',
            'premium.note': 'Según complejidad y alcance del proyecto',
            'premium.cta': 'Consultar Portfolio Premium',
            // Sobre mí
            ...
            'sobre.p2': 'Cada proyecto es único: sin plantillas genéricas, con código escrito a mano y potenciado con IA para que tu sitio sea rápido, accesible y tuyo.',
            // CTA sketch
            'cta_sketch.badge': 'GRATIS · SIN COMPROMISO',
            'cta_sketch.title': 'Boceto de tu sitio en 48hs, sin costo',
            'cta_sketch.subtitle': 'Antes de arrancar, te muestro cómo podría verse tu sitio. Sin costo, sin compromiso.',
            'cta_sketch.btn': 'Solicitar Boceto →',
            // Process
            'process.title': 'Cómo trabajo',
            'process.subtitle': 'Un proceso claro y sin sorpresas, del primer mensaje a la entrega',
            'process.step1.title': 'Consulta gratuita',
            'process.step1.desc': 'Me contás tu idea y te hago las preguntas necesarias para entender tu negocio y objetivos.',
            'process.step2.title': 'Boceto y propuesta',
            'process.step2.desc': 'En 48hs te mando un boceto visual con la estructura del sitio y el presupuesto final.',
            'process.step3.title': 'Desarrollo y revisiones',
            'process.step3.desc': 'Desarrollo el sitio y te voy mostrando el avance. Revisamos juntos hasta que quede perfecto.',
            'process.step4.title': 'Entrega y soporte',
            'process.step4.desc': 'Tu sitio queda online y te acompaño los primeros días para resolver cualquier duda.',
            // Gestión mensual
            'retainer.badge': 'Servicio opcional',
            'retainer.title': 'Gestión mensual',
            'retainer.subtitle': 'El sitio es el punto de partida. Si querés, me sigo ocupando de que tu presencia online funcione todo el año.',
            'retainer.price_note': 'Mes a mes, sin permanencia: la activás solo los meses que la necesitás',
            'retainer.f1.title': 'Hosting siempre activo',
            'retainer.f1.desc': 'Tu sitio online y funcionando, sin que tengas que pensar en eso.',
            'retainer.f2.title': 'Contenido al día',
            'retainer.f2.desc': 'Precios, fotos y textos de temporada actualizados (hasta 2 pedidos por mes).',
            'retainer.f3.title': 'Reporte mensual',
            'retainer.f3.desc': 'Cuántas visitas y consultas te trajo tu web, explicado por mí, en criollo.',
            'retainer.footnote': '¿Necesitás algo más grande —una sección nueva, un rediseño, una funcionalidad? Se cotiza aparte como proyecto.',
            // Pricing
            'pricing.title': 'Planes y Precios',
            'pricing.intro': 'El sitio es el punto de partida. Sumá gestión mensual opcional (USD 25/mes): hosting, contenido siempre al día y un reporte mensual con los resultados de tu web.',
            'pricing.monthly': '+ USD 25/mes de gestión (opcional)',
            ...
            'faq.q3': '¿Qué incluye la gestión mensual?',
            'faq.a3': 'Es un plan opcional de USD 25/mes que podés sumar a tu sitio: hosting, el sitio siempre al día (precios, fotos, textos de temporada) y un reporte mensual claro de visitas y consultas, explicado por mí. Se contrata mes a mes, sin permanencia: podés activarla en temporada y pausarla cuando el negocio para. Los cambios grandes —secciones nuevas, rediseños o funcionalidades— se cotizan aparte como proyecto.',
            ...
            // Chess palmarés
            'chess_palmares.title': 'Experiencia Compitiendo',
            'chess_palmares.subtitle': 'De los provinciales juveniles a los abiertos internacionales',
            'chess_palmares.g1': 'Últimos resultados',
            'chess_palmares.r1.kind': 'Campeón',
            'chess_palmares.r1.title': 'Torneo Otoño',
            'chess_palmares.r1.desc': 'Organizado por el Club de Ajedrez Lago Puelo, con sedes en Lago Puelo y El Bolsón.',
            'chess_palmares.r1.tag': 'puntos',
            'chess_palmares.r2.kind': '9º general',
            'chess_palmares.r2.title': '5º Abierto Internacional Chubut Turístico',
            'chess_palmares.r2.desc': 'Top 10 de la clasificación general con 5,0 puntos, en Esquel.',
            'chess_palmares.r3.kind': 'Mejor Sub-2000',
            'chess_palmares.r3.title': '4º Abierto Internacional de Puerto Madryn',
            'chess_palmares.r3.desc': 'Premio al mejor jugador por debajo de 2000 de Elo.',
            'chess_palmares.g2': 'Etapa juvenil y universitaria',
            'chess_palmares.c1.kind': 'Campeón',
            'chess_palmares.c1.title': 'Campeonato Chubutense Juvenil',
            'chess_palmares.c1.desc': 'Tres títulos provinciales, uno en cada categoría que jugué.',
            'chess_palmares.c2.kind': 'Selección',
            'chess_palmares.c2.title': 'Equipo de Chubut — Juegos Evita',
            'chess_palmares.c2.desc': 'Cinco años consecutivos representando a la provincia.',
            'chess_palmares.c3.kind': 'Selección',
            'chess_palmares.c3.title': 'Equipo de la UNC — JUR',
            'chess_palmares.c3.desc': 'Juegos Universitarios Regionales con la Universidad Nacional de Córdoba.',
            'chess_palmares.c4.kind': '1er puesto',
            'chess_palmares.c4.title': '1er IRT Ciudad de Córdoba',
            'chess_palmares.c4.desc': 'Ganador del torneo, con validez para el rating internacional FIDE.',
            // Chess topics
            ...
            'footer.chess.palmares': 'Palmarés',
        ...
        en: {
            ...
            // Hero
            'hero.title': 'Managed Digital Presence',
            'hero.subtitle': 'I design your custom website and keep it working all year round: hosting, up-to-date content and a monthly results report.',
            'hero.feature_1': '100% Custom',
            'hero.feature_2': 'Responsive on all screen sizes',
            'hero.feature_3': 'Optimized for search engines',
            'hero.badge': '✦ Custom website + optional monthly care',
            ...
            'projects.available_design': 'Design available',
            'projects.category.chess': 'Chess',
            ...
            'premium.subtitle': 'Websites with advanced animations, captivating interactivity and award-worthy design. Digital experiences that leave a mark.',
            'premium.example_title': 'Example: VISUALUV',
            'premium.example_desc': 'Photography portfolio with minimalist design, smooth scroll animations and intuitive navigation.',
            'premium.includes': 'Includes:',
            'premium.feature_animations': 'Advanced animations with GSAP and/or Three.js',
            'premium.feature_interactions': 'Custom interactivity and micro-interactions',
            'premium.feature_performance': 'Performance optimization and Web Vitals',
            'premium.feature_mobile': 'Responsive and mobile-first design',
            'premium.feature_seo': 'Advanced SEO and metadata',
            'premium.feature_support': 'Extended technical support',
            'premium.note': 'Based on project complexity and scope',
            'premium.cta': 'Inquire Premium Portfolio',
            // Sobre mí (EN)
            ...
            'sobre.p2': 'Every project is unique: no generic templates, hand-written code powered by AI so your site is fast, accessible, and truly yours.',
            // CTA sketch
            'cta_sketch.badge': 'FREE · NO COMMITMENT',
            'cta_sketch.title': 'Your site mockup in 48hs, at no cost',
            'cta_sketch.subtitle': 'Before we start, I\'ll show you what your site could look like. Free, no strings attached.',
            'cta_sketch.btn': 'Request Mockup →',
            // Process
            'process.title': 'How I work',
            'process.subtitle': 'A clear, no-surprises process from the first message to delivery',
            'process.step1.title': 'Free consultation',
            'process.step1.desc': 'Tell me your idea and I\'ll ask the right questions to understand your business and goals.',
            'process.step2.title': 'Mockup & proposal',
            'process.step2.desc': 'Within 48hs I send you a visual mockup with the site structure and final budget.',
            'process.step3.title': 'Development & reviews',
            'process.step3.desc': 'I build the site and show you progress along the way. We review together until it\'s perfect.',
            'process.step4.title': 'Delivery & support',
            'process.step4.desc': 'Your site goes live and I\'ll be there for the first few days to answer any questions.',
            // Monthly management
            'retainer.badge': 'Optional service',
            'retainer.title': 'Monthly management',
            'retainer.subtitle': 'The site is the starting point. If you want, I keep making sure your online presence works all year round.',
            'retainer.price_note': 'Month to month, no lock-in: turn it on only for the months you need',
            'retainer.f1.title': 'Hosting, always up',
            'retainer.f1.desc': 'Your site online and running, without you having to think about it.',
            'retainer.f2.title': 'Content kept up to date',
            'retainer.f2.desc': 'Prices, photos and seasonal copy updated (up to 2 requests per month).',
            'retainer.f3.title': 'Monthly report',
            'retainer.f3.desc': 'How much traffic and how many inquiries your site brought in, explained by me in plain terms.',
            'retainer.footnote': 'Need something bigger —a new section, a redesign, a new feature? That\'s quoted separately as a project.',
            // Pricing
            'pricing.title': 'Plans & Pricing',
            'pricing.intro': 'The website is the starting point. Add optional monthly management (USD 25/month): hosting, always up-to-date content and a monthly report with your website results.',
            'pricing.monthly': '+ USD 25/month management (optional)',
            ...
            'faq.q3': 'What does the monthly management include?',
            'faq.a3': "It's an optional USD 25/month plan you can add to your site: hosting, keeping the site up to date (prices, photos, seasonal content) and a clear monthly report of visits and inquiries, explained by me. It runs month to month with no lock-in — turn it on for high season and pause it when things slow down. Bigger changes — new sections, redesigns or new features — are quoted separately as a project.",
            ...
            // Chess palmarés
            'chess_palmares.title': 'Competitive Experience',
            'chess_palmares.subtitle': 'From provincial youth championships to international opens',
            'chess_palmares.g1': 'Latest results',
            'chess_palmares.r1.kind': 'Champion',
            'chess_palmares.r1.title': 'Torneo Otoño',
            'chess_palmares.r1.desc': 'Organized by Club de Ajedrez Lago Puelo, played in Lago Puelo and El Bolsón.',
            'chess_palmares.r1.tag': 'points',
            'chess_palmares.r2.kind': '9th overall',
            'chess_palmares.r2.title': '5th Chubut Turístico International Open',
            'chess_palmares.r2.desc': 'Top 10 finish with 5.0 points, played in Esquel.',
            'chess_palmares.r3.kind': 'Best U-2000',
            'chess_palmares.r3.title': '4th Puerto Madryn International Open',
            'chess_palmares.r3.desc': 'Special prize for the best player rated under 2000.',
            'chess_palmares.g2': 'Youth and university years',
            'chess_palmares.c1.kind': 'Champion',
            'chess_palmares.c1.title': 'Chubut Provincial Youth Championship',
            'chess_palmares.c1.desc': 'Three provincial titles, one in every age category I played.',
            'chess_palmares.c2.kind': 'Team',
            'chess_palmares.c2.title': 'Chubut Team — Juegos Evita',
            'chess_palmares.c2.desc': 'Five consecutive years representing the province.',
            'chess_palmares.c3.kind': 'Team',
            'chess_palmares.c3.title': 'UNC Team — JUR',
            'chess_palmares.c3.desc': 'Regional University Games with the National University of Córdoba.',
            'chess_palmares.c4.kind': '1st place',
            'chess_palmares.c4.title': '1st IRT Ciudad de Córdoba',
            'chess_palmares.c4.desc': 'Tournament winner, a FIDE-rated event.',
            // Chess topics
